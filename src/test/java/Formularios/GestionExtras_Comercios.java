...
public class GestionExtras_Comercios {
	...
	public void test() throws InterruptedException, IOException {
		driver.manage().deleteAllCookies();
		 driver.findElement(By.cssSelector("[placeholder='Correo']")).sendKeys("test1@wposs.com");//brayhanrendon@wposs.com
		...
		System.err.println(i+"- QUEDOOOOO AQUI:"+unique_code);
